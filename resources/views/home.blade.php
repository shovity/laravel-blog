...
@section('content')
<div id="carousel-id" class="carousel slide" data-ride="carousel" data-interval="3000" data-pause="false" data-wrap="false">
    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            ...
            <div class="carousel-caption">
                ...
                <a href="#" id="dori" class="btn btn-success btn-lg" style="margin-bottom: 10px">Dowload now</a>
            </div>
        </div>
